...
export interface PoTableColumn {
   ...
   * @description
   *
   * Controla a exibição da coluna. Caso informar o valor falso, a coluna não será exibida por padrão
   * e ficará disponível para torná-la visível no gerenciador de coluna.
   *
   * @default `true`
   */
  visible?: boolean;
